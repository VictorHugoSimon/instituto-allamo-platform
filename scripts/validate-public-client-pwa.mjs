...
must(runtime,"KEY='allamo_public_pwa_tenant'",'fallback persiste tenant instalado');
must(runtime,"matchMedia('(display-mode: standalone)')",'runtime detecta app instalado');
must(runtime,'source=pwa-fallback','fallback nunca cai silenciosamente na raiz interna');
...
console.log('OK: PWA público é multitenant, reabre empresa canônica e possui fallback contra contexto antigo.');
