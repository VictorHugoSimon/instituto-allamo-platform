...
if(!build.includes(requiredOrder))throw new Error('Saneamento de sessão/PWA/JSON deve ser o último hardening do build.');
console.log('OK: cache, sessão estável entre abas, BFCache, Service Worker, PWA tenant-safe e bundle JSON final revalidam sem bloquear a interface.');
