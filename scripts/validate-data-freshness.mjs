...
if(!String(pkg.scripts['build:work']).includes('harden-portal-runtime.mjs && node scripts/enforce-live-first-paint.mjs && node scripts/harden-data-freshness.mjs'))throw new Error('Ordem do build pode reintroduzir cache antigo.');
console.log('OK: cache, sessão, BFCache, Service Worker e contexto multiempresa revalidam sem bloquear a interface.');
