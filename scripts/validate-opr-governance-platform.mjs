...
const jsFiles=['src/opr-governance-platform-api.js','src/opr-permanent-report-api.js','src/opr-pop-versioning-api.js','src/opr-action-v2-api.js','scripts/harden-opr-governance-platform.mjs','scripts/harden-opr-action-v2.mjs','scripts/harden-opr-plan-v2-ui.mjs','scripts/harden-opr-pop.mjs','public/opr/assets/platform.js','public/opr/assets/entity-page.js'];jsFiles.forEach(check);
