...
must(reviewApi,"WHERE id=? AND status='unresolved'",'transição somente a partir de unresolved');
must(reviewApi,"result.meta.changes",'resultado D1 usado para validar atualização atômica');
must(reviewApi,"provider_event_concurrent_review",'conflito de revisão concorrente retorna 409');
