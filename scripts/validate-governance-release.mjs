...
forbid(stageWorkflow,'validate-semeali-d1-sales-intelligence.mjs','Release padrão do Painel PMO não deve depender de tenant Semeali');
forbid(stageWorkflow,'smoke-service-hub-stage.mjs','Release padrão do Painel PMO não deve depender de Valkíria Service Hub');
...
console.log('OK: release governado — STAGE/PROD preservam baseline zero e o release padrão do Painel PMO não depende de tenants/projetos específicos.');
