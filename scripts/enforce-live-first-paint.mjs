...
if(!html.includes('window.__allamoBootSeen={companies:false,projects:false,public:false}'))throw new Error('Boot guard não rastreia APIs críticas.');
...
if(!html.includes('return !!seen.public'))throw new Error('Link público pode revelar antes da API pública.');
if(!html.includes('Carregando dados do Portal PMO'))throw new Error('Estado neutro de carregamento ausente.');
fs.writeFileSync(file,html);
console.log('OK: primeiro paint bloqueia fotografia demo até os dados reais do tenant carregarem.');
