...
// Bases legadas podem não possuir gmud.project. O GET de /api/releases não precisa
// exigir a coluna para carregar viradas. SELECT * mantém o endpoint funcional durante
// a evolução aditiva do schema; após a migration, g.project continua disponível.
