...
new Function(responsive);new Function(admin);new Function(raci);new Function(watchdog);new Function(clientReports);new Function(releases);new Function(clientApi);new Function(publicApi);
...
for(const f of ['src/public-published-reports-api.js','src/report-client-api-guard.js','src/report-admin-navigation.js','src/client-published-reports.js','src/release-history-ui.js','src/raci-visual.js','src/responsive-usability.js'])must(build,f,'injeção '+f);
