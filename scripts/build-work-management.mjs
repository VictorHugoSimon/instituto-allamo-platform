...
console.log('OK: Work Management, Reports/Roadmap, editor dinâmico, Copiloto PMO IA (Cloudflare gratuito + OpenAI opcional), watchdog pós-unpack e melhorias executivas sincronizados.');
