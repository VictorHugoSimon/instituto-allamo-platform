...
w=sync(w,'    // BEGIN ALLAMO LEGACY REPORT AI','    // END ALLAMO LEGACY REPORT AI',legacyReportAiApi,"    // STATUS REPORT (por projeto quando vem ?project=, senão por empresa)",'    ');
...
console.log('OK: Work Management, Reports/Roadmap, editor dinâmico, Copiloto PMO IA, watchdog pós-unpack e melhorias executivas sincronizados.');
