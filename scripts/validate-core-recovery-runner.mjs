...
if(destructive.test(ps)||destructive.test(portable)||destructive.test(smoke)||destructive.test(schema))throw new Error('Runner contém padrão SQL destrutivo.');
...
must(schema,"CREATE",'script reconhece criação aditiva');
