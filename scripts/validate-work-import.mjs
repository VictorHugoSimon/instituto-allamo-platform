...
must(fileUploadHardener,"ext==='xlsx'",'leitura XLSX');
must(fileUploadHardener,"ext==='xls'",'leitura XLS legado');
must(fileUploadHardener,"ext==='csv'||ext==='tsv'",'leitura CSV/TSV local');
must(fileUploadHardener,"XLSX.read(data,{type:'array',cellDates:true})",'parsing local do workbook');
