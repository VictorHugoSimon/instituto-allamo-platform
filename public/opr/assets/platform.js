(()=>{
  ...
  const navGroups=[
    {label:'Início',items:[
      ['/opr/','Portal','01 · Visão Geral']
    ]},
    {label:'Entender e planejar',items:[
      ['/opr-blueprint/','Blueprint','02 · Blueprint'],
      ['/opr-plano-de-acao/','Plano de Ação','03 · Plano de Ação'],
      ['/opr-requisitos/','Requisitos','04 · Requisitos']
    ]},
    {label:'Executar e controlar',items:[
      ['/opr-integracoes/','Integrações','05 · Integrações'],
      ['/opr-riscos/','Riscos','06 · Riscos'],
      ['/opr-mapa-implantacao/','Mapa Mestre','07 · Mapa Mestre']
    ]},
    {label:'Validar e decidir',items:[
      ['/opr-plano-testes/','Testes','08 · Testes'],
      ['/opr-defeitos/','Defeitos','09 · Defeitos'],
      ['/opr-readiness/','Readiness','10 · Readiness'],
      ['/opr-decisoes/','Decisões','11 · Decisões']
    ]},
    {label:'Governança e conhecimento',items:[
      ['/opr-status-report/','Status Report','12 · Status Report'],
      ['/opr-pop/','POP','13 · POP'],
      ['/opr-documentos/','Documentos','14 · Documentos'],
      ['/opr-biblioteca/','Biblioteca','15 · Biblioteca / Drive']
    ]}
  ];
  ...
  const supportRoutes=[
    ['/opr/','Portal'],['/opr-blueprint/','Blueprint'],['/opr-requisitos/','Requisitos'],['/opr-integracoes/','Integrações'],['/opr-riscos/','Riscos'],['/opr-plano-testes/','Testes'],['/opr-defeitos/','Defeitos'],['/opr-readiness/','Readiness'],['/opr-decisoes/','Decisões'],['/opr-documentos/','Documentos'],['/opr-biblioteca/','Biblioteca']
  ];
  ...
  const groupLinks=(items,active)=>items.map(([u,key,label])=>`<a class="${active===key?'on':''}" href="${u}"><span class="navtext">${esc(label)}</span></a>`).join('');
