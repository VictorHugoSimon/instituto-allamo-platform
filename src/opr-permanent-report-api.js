...
if(path==='opr-platform/status-report'&&request.method==='GET'){
  ...
  const hasAttention=Number(a.late||0)||Number(a.pending_data||0)||riskCritical||intBlocked||pendingDec||testTotal===0||total===0;
  const overall=(p1||readyBlock)?'VERMELHO':(hasAttention?'AMARELO':'VERDE');
