(()=>{
  ...
  const style=`
    ...
    .arm-inline{width:100%;min-width:0;min-height:760px;background:#f4f3f0;border:1px solid #dedbd5;border-radius:16px;overflow:hidden;box-shadow:0 8px 26px rgba(20,22,27,.06);position:relative}
