(()=>{
  ...
  // Captura o botão público antes do listener legado para garantir que o manifesto tenant-safe seja usado.
  ...
  // O DOM inteiro pode ser trocado pelo unpack; o manifesto público precisa sobreviver.
