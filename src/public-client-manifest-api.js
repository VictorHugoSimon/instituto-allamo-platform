...
if(path==='public-client-manifest'&&request.method==='GET'){
  ...
  return new Response(JSON.stringify(manifest),{status:200,headers:{'content-type':'application/manifest+json; charset=utf-8','cache-control':'no-store, no-cache, must-revalidate, max-age=0','x-allamo-tenant':canonicalId}});
}
